...
public interface DataContext {
	...
	public DataResult addBalanceTarget(java.sql.Date startDate, java.sql.Date endDate, double amount, String name) throws SQLException;
	...
	public DataResult addEvent(Integer eventType, Integer animalId, java.sql.Date dueDate, java.sql.Date date, String details, Integer contactInvolved) throws SQLException;
	public DataResult addOrUpdateContact(String firstName, String lastName, String phone_1, String phone_2, String email_1, String email_2, String address, Integer city, String otherDetails, String identityCard, java.sql.Date birthDate) throws SQLException;
	...
	public DataResult getBalanceTarget(String ids, java.sql.Date startDate, java.sql.Date endDate) throws SQLException;
	public DataResult getCities() throws SQLException;
	public DataResult getContacts(Integer[] contactTypes, Integer[] contactTypeGroups, String contactName, Integer minAge) throws SQLException;
	...
	public DataResult getEvents(Integer[] eventTypes, Integer[] eventTypeGroups, Integer[] animalIds, java.sql.Date[] eventDates, Boolean openedEvents, java.sql.Date startDate, java.sql.Date endDate) throws SQLException;
	...
	public DataResult getPaymentsReports(Integer[] animalIds, java.sql.Date[] paymentDates, Integer[] contactsIds, Integer[] paymentTypes, Integer[] transactionTypes) throws SQLException;
	...
	public DataResult getTransactions(Integer[] transactionIds, Integer[] transactionType, Integer[] eventTypes, Integer[] eventTypeGroups, Integer[] animalIds, java.sql.Date[] transactionDates, java.sql.Date startDate, java.sql.Date endDate, Boolean unpaiedTransaction) throws SQLException;
	...
	public DataResult updateBalanceTarget(Integer id, java.sql.Date startDate, java.sql.Date endDate, double amount, String name) throws SQLException;
	...
	public DataResult updateEvent(Integer id, Integer eventType, Integer animalId, java.sql.Date dueDate, java.sql.Date date, String details, Integer contactInvolved) throws SQLException;
